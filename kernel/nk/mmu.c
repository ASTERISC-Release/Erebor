...
// @Deprecated. Not used anymore. Call `set_page_protection()` dynamically at L1-L4 declarations
...
//   printk("VA 0xffff8881800462a8's val=0x%lx.\n", *(unsigned long*)0xffff8881800462a8);
  ...
  // print it again
  /* Chuqi: 
   * This is very important to understand the implication of doing `printk` in secure monitor within TD CVM.
   * Basically, `printk` to the console would cause a #VE.
   * tdcall's gate would revoke the key permission Lmao.
   */
  ...
  /* Chuqi: 
   * DEPRECATED here, call set_page_protection() at L1-L4 PTP declarations above 
   */
  // makePTReadOnly(); 
  ...
  //  dirty SEV clear this pgd for poking address
