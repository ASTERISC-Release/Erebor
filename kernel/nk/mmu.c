...
inline void _load_cr3(unsigned long data)
{ 
 ...
 */
static inline void __update_mapping (uintptr_t * pageEntryPtr, page_entry_t val);
...
static inline void init_MMULock(void) {
    MMULock = 0;
}

static inline char MMULock_Try(void) {
